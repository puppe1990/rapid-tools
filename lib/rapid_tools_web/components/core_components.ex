defmodule RapidToolsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RapidToolsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RapidToolsWeb.Gettext, "errors", msg, opts)
    end
  end
