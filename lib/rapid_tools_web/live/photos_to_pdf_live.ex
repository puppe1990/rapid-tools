defmodule RapidToolsWeb.PhotosToPdfLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app
      ...
      show_header={false}
    >
      <section class="h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.16),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(8,145,178,0.16),_transparent_30%),linear-gradient(180deg,_rgba(240,249,255,1)_0%,_rgba(255,255,255,1)_54%,_rgba(236,254,255,1)_100%)]">
