defmodule RapidToolsWeb.AudioConverterLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app
      ...
      show_header={false}
    >
      <section class="h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.16),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(59,130,246,0.12),_transparent_26%),linear-gradient(180deg,_rgba(244,248,246,1)_0%,_rgba(255,255,255,1)_50%,_rgba(241,247,249,1)_100%)]">
