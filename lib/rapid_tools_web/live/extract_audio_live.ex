defmodule RapidToolsWeb.ExtractAudioLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app
      ...
      show_header={false}
    >
      <section class="h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(168,85,247,0.16),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(236,72,153,0.14),_transparent_28%),linear-gradient(180deg,_rgba(249,244,252,1)_0%,_rgba(255,255,255,1)_52%,_rgba(250,243,248,1)_100%)]">
